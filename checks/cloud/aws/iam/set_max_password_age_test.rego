...
test_allow_password_with_max_age_days_over_90 if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "maxagedays": {"value": 91}}}}}
	test.assert_empty(check.deny) with input as inp
}

test_disallow_password_with_max_age_days_within_90 if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "maxagedays": {"value": 60}}}}}
