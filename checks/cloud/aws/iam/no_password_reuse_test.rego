...
test_disallow_policy_with_less_than_5_password_reuse if {
	inp = {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "reusepreventioncount": {"value": 1}}}}}
...
test_allow_policy_with_5_password_reuse if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "reusepreventioncount": {"value": 5}}}}}
