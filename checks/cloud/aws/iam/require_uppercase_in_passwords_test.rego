...
test_allow_policy_require_uppercase_in_passwords if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "requireuppercase": {"value": true}}}}}
	test.assert_empty(check.deny) with input as inp
}

test_disallow_policy_no_require_uppercase_in_passwords if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "requireuppercase": {"value": false}}}}}
