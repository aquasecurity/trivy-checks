...
test_allow_policy_require_lowercase_in_passwords if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "requirelowercase": {"value": true}}}}}

	test.assert_empty(check.deny) with input as inp
}

test_disallow_policy_no_require_lowercase_in_passwords if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "requirelowercase": {"value": false}}}}}
