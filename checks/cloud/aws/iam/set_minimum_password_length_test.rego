...
test_allow_password_length_over_14 if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "minimumlength": {"value": 15}}}}}
	test.assert_empty(check.deny) with input as inp
}

test_disallow_password_length_under_14 if {
	inp := {"aws": {"iam": {"passwordpolicy": {"__defsec_metadata": {"managed": true}, "minimumlength": {"value": 13}}}}}
